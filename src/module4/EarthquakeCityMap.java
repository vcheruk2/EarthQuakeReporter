...
public class EarthquakeCityMap extends PApplet {
	...
	private void addKey() {	
		...
		ellipse(50, 150, 2*TRI_SIZE, 2*TRI_SIZE);
		fill(color(255, 255, 255));
		rect(50,175,10,10);
		
		fill(255,255,0);
		ellipse(50,225,2*TRI_SIZE,2*TRI_SIZE);
		fill(0,0,255);
		ellipse(50,250,2*TRI_SIZE,2*TRI_SIZE);
		fill(255,0,0);
		ellipse(50,275,2*TRI_SIZE,2*TRI_SIZE);
		fill(255,255,255);
		ellipse(50,300,2*TRI_SIZE,2*TRI_SIZE);
		fill(0,0,0);
		text("X",46,298);
